...
\begin{itemize}
  \item relevant theoretical work~\cite{DBLP:conf/aaai/MalhotraS22} (there is
        more, e.g., the LICS 2018 paper)
...
\todo[inline]{Disambiguate between \protect\Crane, \textsc{Crane}, and
  \Cranetwo}
  ...
  \item
        \begin{itemize}
          ...
          \item \UFO{} is the input format supported by a version of
                ...
                version\footnote{\url{https://www.comp.nus.edu.sg/~tvanbr/software/fastwfomc.tar.gz}}
