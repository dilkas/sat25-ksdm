...
\Cref{fig:plot} shows total runtime values as a measure of the overall
...
\todo[inline,caption={}]{
  \begin{itemize}
    \item Add info about \textsc{ForcLift} (taking care of infinities)
    \item Turn the above paragraph into a table.
    \item Mention two types of experiments earlier in the section.
  \end{itemize}
}
