...
\todo[inline,caption={}]{
  \begin{itemize}
    \item say something about what $\expr{}$ can contain (function calls,
          various arithmetic operations, summations, non-negative integer
          constants, variables introduces by the function signature or
          summations)
  \end{itemize}
}
...
\todo[inline,caption={}]{ Turn these notes into a coherent description (that
  ...
  \begin{itemize}
    ...
    \item For a literal or a clause $C$, let $\Doms(C)$ denote the set of the
          corresponding domains. Make sure an example illustrates this.
  \end{itemize}
}
