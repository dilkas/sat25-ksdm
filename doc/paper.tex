...
\begin{description}
  ...
  \item[Domain recursion:] we merge $P(c)$ and $\forall X \in \Delta\text{.
        }X \ne c \Rightarrow P(X)$ into $\forall X \in \Delta\text{. }P(X)$.
        NOTE: the clauses may have other constraints, variables, etc. I could
        describe this more formally.
\end{description}
