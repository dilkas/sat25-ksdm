...
\begin{table}[t]
  ...
  \caption{A comparison of the three logics used in FOMC\@. The
    ...
    latter depending on the domain size, $P$ is a predicate, and $x$ and $y$ are
...
from \FO{} to \Ctwo{} and \UFO{}. As \friends{} is a relatively simple sentence,
it remains the same in \Ctwo{} and \UFO{}. For \functions{}, in \Ctwo{} one
would write
\[
  \forall x \in \Delta\text{. }\exists^{=1} y \in \Delta\text{. }P(x, y).
\]
In \UFO{}, the same could be written as
...
the terms in the definition of WFOMC cancel out. The translation of
\bijections{} is similar to that of \functions{}. In \Ctwo{}, one could write
\[
