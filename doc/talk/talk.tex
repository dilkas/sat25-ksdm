  ...
  \onslide<6->{
    \begin{block}{First-Order Model Counting (FOMC)}
      \begin{itemize}
        ...
        \begin{itemize}
          \item of a domain or a Cartesian product of domains
        \end{itemize}
  ...
  \begin{alertblock}{Issues We Are Going to Address}
    \begin{description}
      \item[Completeness:] recursive functions (like \structure{$g$}) have
            \alert{no base cases}
      \item[Usability:] how do I compute, e.g., \structure{$f(7, 7)$}? \hfill
  ...
  \begin{block}{From Previous
    ...
    \begin{itemize}
      ...
      \item And there is a bijection between the \alert{parameters} of
            \structure{$f$} and the \alert{domains} of \structure{$\phi$}
    \end{itemize}
  \end{block}
  \begin{example}
    \begin{itemize}
