...
% * draw a clear line between prior work and new developments
% * minimize use of enumerate
...
% TODO: Section 2 until 2.3 (Algebra) could be drastically shortened
...
% TODO: Skolemization is a procedure that transforms a formula with existential
% quantifiers into an ’equivalent’ formula without existential quantifiers with
% the same WFOMC.
...
% TODO: this subsection could be expanded a little
