...
% * finish add DOIs or URLs to (non-book) references (and reformatting indentation) (and check reference formatting)
...
% TODO (somewhere): Recall that each equation is either the definition (did I
% define what a definition is?) of a function or the definition of a base case
