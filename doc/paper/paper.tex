...
% TODO: add another affiliation for K (separate by \and)
...
\acknowledgements{The first two authors contributed equally. Part of the
  ...
  Singapore.}
% TODO: acknowledge the reviewers (for making this work readable)
...
% NOTE: page limit of 20 pages, excluding title-page and bibliography but
% including any appendices

% TODO: (at the end): remove all comments
\begin{document}
