...
\todo[inline,caption={}]{
  \begin{itemize}
    \item Adjust the introduction to the new structure (with more subsections)
    \item If I need more space elsewhere, shortening the preliminaries to two
          pages could work (I could expand the introduction by 0.5 page)
  \end{itemize}
}
...
\todo[inline]{Make sure the distinction between function definitions and
  equations is clear.}
...
\todo[inline]{Connect this with the preliminaries?}
...
\todo[inline]{The example below builds on \cref{sec:crane}. Shorten it.}
...
\todo[inline]{Check if the above is still clear given all the changes.}
