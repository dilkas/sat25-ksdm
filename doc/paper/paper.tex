...
% TODO: somehow indicate that source code will be available (a redacted link?)
...
% TODO: must find a way to include the implementation in the submission
...
\citeauthor{DBLP:conf/ijcai/BroeckTMDR11}~\shortcite{DBLP:conf/ijcai/BroeckTMDR11}
...
\citeauthor{DBLP:conf/kr/DilkasB23}~\shortcite{DBLP:conf/kr/DilkasB23}.
...
\citeauthor{DBLP:conf/kr/DilkasB23}~\shortcite{DBLP:conf/kr/DilkasB23}. Third,
