...
\end{algorithm}
% TODO: replace x_i-c_i on Line 7 of Algorithm 2 with a generalisation of x_i
% that can be an arbitrary summation/subtraction of domain sizes (propagating
% this change to the rest of the paper)

% TODO: a function call with a constant should always mean that that function
% should have a base case, not just when it's in the same function
