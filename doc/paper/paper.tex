...
\todo[inline,caption={}]{Add a discussion of the innovation aspect and technical
  parts. Motivate each part of \Cranetwo{} (e.g., how \FindBaseCases addresses
  key issues in \textsc{Crane}).}
...
% Generally, let $\phi$ be a formula with two domains $\Gamma$ and $\Delta$, and
...
\begin{observation}\label{observation2}
  ...
  \Propagate{$\phi$, $\Delta$, $n$} returns a formula with no variables
...
\todo[inline]{Expand the section, adding a more thorough and independent
