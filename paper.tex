...
An important change to the compilation algorithm. We make the FCGs satisfy the
following property. For every domain $\Delta$, for every directed path $P$
without Ref nodes, the number of atom counting or (generalised) domain recursion
operations on $\Delta$ on $P$ is at most one.
